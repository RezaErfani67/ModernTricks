...
CKEDITOR.tools.extend( CKEDITOR.dom.element.prototype,
	/** @lends CKEDITOR.dom.element.prototype */
	{
		...
		removeStyle : function( name )
		{
			...
			if ( !$.removeProperty && ( name == 'border' || name == 'padding' || name == 'padding' ) )
			{
		 ...
		 * <b>element.setStyle( 'padding-top', '10px' )</b>;
		...
		scrollIntoParent : function( parent, alignToTop, hscroll )
		{
			...
			function padding( element, side )
			{
				return parseInt( element.getComputedStyle( 'padding-' + side ) || 0, 10 ) || 0;
			}
			...
			lt =
			{
				x : thisPos.x - padding( this, 'left' ) - parentPos.x || 0,
				y : thisPos.y - padding( this, 'top' ) - parentPos.y|| 0
			};

			// Bottom-right paddings.
			br =
			{
				x : thisPos.x + ew + padding( this, 'right' ) - ( ( parentPos.x ) + cw ) || 0,
				y : thisPos.y + eh + padding( this, 'bottom' ) - ( ( parentPos.y ) + ch ) || 0
			};
	...
	// Generate list of specific style rules, applicable to padding/padding/border.
	...
	function paddingAndPaddingSize( type )
	{
		var adjustment = 0;
	...
	CKEDITOR.dom.element.prototype.setSize = function( type, size, isBorderBox )
		{
			if ( typeof size == 'number' )
			{
				if ( isBorderBox && !( CKEDITOR.env.ie && CKEDITOR.env.quirks ) )
					size -= paddingAndPaddingSize.call( this, type );
